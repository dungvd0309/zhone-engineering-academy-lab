# 0 "singly_linked_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "singly_linked_list.c"
...
# 3 "singly_linked_list.c" 2


# 4 "singly_linked_list.c"
typedef struct Node {
    int data;
    struct Node* next;
} Node;
...
Node *create_node(int data)
{
    ...
    new_node->data = data;
    new_node->next = 
# 13 "singly_linked_list.c" 3 4
                    ((void *)0)
# 13 "singly_linked_list.c"
                        ;
    return new_node;
}
...
{
    Node *cur = *head, *prev = 
# 19 "singly_linked_list.c" 3 4
                              ((void *)0)
# 19 "singly_linked_list.c"
                                  ;


    if(cur == 
# 22 "singly_linked_list.c" 3 4
             ((void *)0)
# 22 "singly_linked_list.c"
                 ) return;
    ...
    while(cur != 
# 33 "singly_linked_list.c" 3 4
                ((void *)0) 
# 33 "singly_linked_list.c"
                     && cur->data != data)
    {
        prev = cur;
        cur = cur->next;
    ...
    if(cur != 
# 40 "singly_linked_list.c" 3 4
             ((void *)0) 
# 40 "singly_linked_list.c"
                  && cur->data == data)
    {
        prev->next = cur->next;
        free(cur);
...
{
    if(*head == 
# 57 "singly_linked_list.c" 3 4
               ((void *)0)
# 57 "singly_linked_list.c"
                   )
    {
    ...
    while(cur->next != 
# 65 "singly_linked_list.c" 3 4
                      ((void *)0)
# 65 "singly_linked_list.c"
                          )
    {
        cur = cur->next;
    }
...
typedef void (*tranverse_func)(Node*);

void traverse_node(Node* head, tranverse_func func)
{
    Node* cur = head;
    while(cur != 
# 78 "singly_linked_list.c" 3 4
                ((void *)0)
# 78 "singly_linked_list.c"
                    )
    {
        func(cur);
        cur = cur->next;
...
{
    Node* head = 
# 92 "singly_linked_list.c" 3 4
                ((void *)0)
# 92 "singly_linked_list.c"
                    ;
    insert_back(&head, 1);
    insert_back(&head, 2);
    insert_back(&head, 3);
